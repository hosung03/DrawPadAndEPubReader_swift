...
class EPubReaderPageIndicator: UIView {
...
//        minutesLabel.alpha = 0
    ...
    fileprivate func reloadViewWithPage(_ page: Int) {
        let pagesRemaining = EPubReader.needsRTLChange ? totalPages-(totalPages-page+1) : totalPages-page
...
extension EPubReaderPageIndicator: CAAnimationDelegate {
