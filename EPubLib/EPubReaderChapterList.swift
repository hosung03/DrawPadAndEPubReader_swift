...
@objc protocol EPubReaderChapterListDelegate: class {
    /**
...
class EPubReaderChapterList: UITableViewController {
    weak var delegate: EPubReaderChapterListDelegate?
    ...
    override func viewDidLoad() {
        ...
        tableView.register(EPubReaderChapterListCell.self, forCellReuseIdentifier: reuseIdentifier)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier, for: indexPath) as! EPubReaderChapterListCell
