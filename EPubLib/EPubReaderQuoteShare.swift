...
class EPubReaderQuoteShare: UIViewController {
    ...
    func shareQuote(_ sender: UIBarButtonItem) {
        ...
        let act = EPubReaderSharingProvider(subject: subject, text: text)
...
extension EPubReaderQuoteShare: UICollectionViewDataSource {
...
extension EPubReaderQuoteShare: UICollectionViewDelegate {
...
extension EPubReaderQuoteShare: UIImagePickerControllerDelegate {
