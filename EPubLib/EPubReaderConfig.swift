...
// MARK: - EPubReaderScrollDirection

/**
 Defines the Reader scrolling direction
 */
public enum EPubReaderScrollDirection: Int {
...
public struct ClassBasedOnClickListener {
	...
	/**
     Initializes a `ClassBasedOnClickListener` instance. Append it to the `classBasedOnClickListeners` property from the `EPubReaderConfig` to receive on click events. The default `selectAll` value is `true`.
...
// MARK: - EPubReaderConfig

/**
 Defines the Reader custom configuration
 */
open class EPubReaderConfig: NSObject {
	...
	*/
    ...
    open var menuBackgroundColor = UIColor(rgba: "#006400") //UIColor.white
    
    /// Menu separator Color
    open var menuSeparatorColor = UIColor(rgba: "#006400") //UIColor(rgba: "#D7D7D7")
    
    /// Menu text color
    open var menuTextColor = UIColor.white //UIColor(rgba: "#767676")
    ...
    open var scrollDirection: EPubReaderScrollDirection = .defaultVertical
